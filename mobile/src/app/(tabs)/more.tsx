...
const LINKS = [
  { href: '/offices', label: 'Administrative offices', hint: "Principal's Office, Student Affairs, Registrar…", icon: 'business-outline' },
  { href: '/scan', label: 'Scan a QR anchor', hint: 'Fix your indoor position or check in', icon: 'qr-code-outline' },
  { href: '/assistant', label: 'Campus assistant', hint: 'Ask for a room, route or the shortest queue', icon: 'sparkles-outline' },
  { href: '/notifications', label: 'Notifications', hint: 'Class reminders, ticket calls, announcements', icon: 'notifications-outline' },
  { href: '/profile', label: 'Profile & settings', hint: 'Your details, device and session', icon: 'person-outline' },
] as const;
