    ...
    <Screen onRefresh={buildings.reload} refreshing={buildings.loading}>
      ...
      <View style={styles.padded}>
        ...
        <View style={styles.actions}>
          <Pressable style={styles.action} onPress={() => router.push('/student/scan' as any)}>
          ...
          <Pressable style={styles.action} onPress={() => router.push('/student/room/A-103' as any)}>
      ...
      {searching ? (
        <View style={styles.padded}>
          ...
          {rooms.data?.items.map((room) => (
            <Pressable key={room.id} onPress={() => router.push(`/student/room/${encodeURIComponent(room.code)}` as any)} style={styles.roomRow}>
              <View style={{ flex: 1 }}>
