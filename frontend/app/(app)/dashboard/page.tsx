...
export default function DashboardPage() {
  const { user } = useAuth();
  const dashboard = useAsync((signal) => meApi.dashboard(), []);
              ...
              <div className="rounded-[12px] border border-ink-100 bg-gradient-to-br from-brand-50/70 to-white p-4">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  ...
                  <div className="flex flex-col gap-2">
                    {nextClass.room_code ? (
                      <Link href={`/navigate?to=${encodeURIComponent(nextClass.room_code)}`}>
                    ...
                    {nextClass.room_id ? (
                      <Link href={`/rooms/${nextClass.room_code ?? nextClass.room_id}`}>
          ...
          <Card>
            ...
            {queueTicket ? (
              <div className="rounded-[12px] border border-ink-100 p-4">
                ...
                <Link href="/queue" className="mt-3 block">
                  <Button variant="secondary" size="sm" className="w-full">
                    Open queue ticket
                  </Button>
                </Link>
          ...
          <Card>
            ...
            {officeTicket ? (
              <div className="rounded-[12px] border border-ink-100 p-4">
                ...
                <Link href={`/offices/${officeTicket.office.id}`} className="mt-3 block">
                  <Button variant="secondary" size="sm" className="w-full">
                    Open office ticket
                  </Button>
                </Link>
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-2">
        <Card>
          <SectionHeading
            ...
            action={
              <Link href="/announcements" className="text-[12.5px] font-medium text-brand-600 hover:text-brand-700">
                All notices
              </Link>
            }
          />
        ...
        <Card>
          <SectionHeading
            ...
            action={
              <Link href="/events" className="text-[12.5px] font-medium text-brand-600 hover:text-brand-700">
                All events
              </Link>
            }
          />
