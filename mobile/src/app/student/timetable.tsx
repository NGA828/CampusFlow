...
export default function TimetableScreen() {
  ...
  const timetable = useLoader(() => studentApi.timetable(), []);
          ...
          <Card key={entry.id} style={{ marginBottom: spacing.md }}>
            ...
            {entry.room_code ? (
              <View style={styles.actions}>
                ...
                {entry.room_id ? (
                  <Pressable onPress={() => router.push(`/student/room/${encodeURIComponent(entry.room_code ?? '')}` as any)} style={styles.action}>
