...
export default function OfficeTicketPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (ticket.error) {
    return (
      <div>
        <PageHeader title="Office ticket" breadcrumb={[{ label: 'Offices', href: '/student/services/offices' }, { label: 'Ticket' }]} />
  ...
  return (
    <div>
      <PageHeader
        ...
        breadcrumb={[{ label: 'Offices', href: '/student/services/offices' }, { label: current.office.name, href: `/student/services/offices/${current.office.code}` }, { label: current.ticket.ticket_number }]}
        actions={
          ...
          <Card>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              {current.office.room_code ? (
                <Link href={`/student/campus/map?route=${encodeURIComponent(current.office.room_code)}`}>
